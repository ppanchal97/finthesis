            ...
            <div className="relative bg-white p-4 rounded-lg" style={{ width: '800px' }}>
                ...
                {loading ? (
                    ...
                    <div className="text-left mt-4">
                        ...
                        Traders on the NYSE floor react to the latest news conference held by Fed Chair Jerome Powell. Powell's comments are closely scrutinized for indications of future monetary policy moves.</p>
                        ...
                        <p><strong>Circulation of Zimbabwe's New ZiG Currency</strong><br/>
                        ...
                        Billionaire Carlos Slim is thrust into the spotlight as WOM’s bonds see a surprising rebound. Slim's involvement is seen as a pivotal factor in the bond's recovery.</p>
